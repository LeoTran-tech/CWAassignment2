...
const BASE_URL = 'http://ec2-54-237-223-193.compute-1.amazonaws.com:4080/api/questions';
...
test.describe('Questions API – Full CRUD Flow', () => {
  ...
  // ⚠️ Step 6: PATCH expect duplicate (trying to rename one question to match another)
